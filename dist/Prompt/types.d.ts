export declare namespace Prompt {
    type Parser<T = any> = (value: string, answers: T, config: Record<string, unknown>) => string;
    type Choice = {
        name: string;
        value: string;
    };
    type Choices<T = any> = Choice[] | ((answers: T, config: Record<string, unknown>) => Choice[]);
    interface PromptQuestion<T = any> {
