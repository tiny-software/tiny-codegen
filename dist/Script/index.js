...
class Script {
    constructor(scriptPath) {
        ...
        if (!(codeGen instanceof CodeGen_1.CodeGen)) {
            throw new Error(`Script ${scriptPath} must export an instance of CodeGen`);
        }
        this.config.extend(Object.assign({ onParseAllAnswers: null }, codeGen.getConfig()));
        ...
        if (this.steps.length === 0) {
            this.steps.push(new Step_1.Step(codeGen.getPrompts()));
        }
        this.validate();
    ...
    parseAllAnswers(answers) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.config.hasCallback('onParseAllAnswers')) {
                ...
                const parsedAnswersCallbackAfter = yield onParseAllAnswers(answers, this.config.getConfig());
    ...
    onFilesCreated(files) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.config.hasCallback('onFilesCreated')) {
                yield this.config.get('onFilesCreated')(files, this.config.getConfig());
            }
        });
    }
}
